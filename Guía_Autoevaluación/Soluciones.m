...
cd('/Users/afl/Dropbox/Universidad/Sexto año/Dynamic Programming/Autoevaluación_Matlab')
...
saveas(2,'Figuras/Figura_P3.eps')
saveas(2,'Figuras/Figura_P3.jpeg')

% Es posible notar que la solución se vuelve inestable ante valores de
% sigma mayores a 7. Ello ocurre debido a que estamos frente a una solución
% numérica, la que depende de (i) el número de decimales que reconozca el
% programa; (ii) los valores de los parámetros estructurales del problema;
% (iii) la grilla sobre la cual se trabaja. El objetivo de esta pregunta,
% además de tener una aplicación "económica" de Matlab, era aprender la 
% lógica para llegar a una solución numértica y uno de los los potenciales 
